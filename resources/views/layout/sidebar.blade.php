        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ active_class(['email/*']) }}">
                ...
                <div class="collapse {{ show_class(['email/*']) }}" id="email">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route("stakeholder.all") }}"
                               class="nav-link {{ active_class(['stakeholder/']) }}">All Stakeholders</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("stakeholder.add") }}"
                               class="nav-link {{ active_class(['stakeholder/*']) }}">Add Stakeholder</a>
                        </li>
            ...
            <li class="nav-item {{ active_class(['products/*']) }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#products" role="button"
                   aria-expanded="{{ is_active_route(['products/*']) }}" aria-controls="email">
                    ...
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route("products.all") }}"
                               class="nav-link {{ active_class(['products/']) }}">All Products</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("product_category.all") }}"
                               class="nav-link {{ active_class(['products/*']) }}">All Category</a>
                        </li>
